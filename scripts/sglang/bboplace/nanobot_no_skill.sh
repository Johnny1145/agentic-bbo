...
cmd=(
  ...
  --setting-version sglang_nanobot_validation_no_skill_5eval_v1
  --n-initial-points 0
  --optimizer-budget "${NANOBOT_VALIDATION_EVALUATIONS}"
  --output-dir "${RUN_ROOT}/bboplace/no-skill/outputs"
  --summary-dir "${RUN_ROOT}/bboplace/no-skill/summary"
  --jobs "${JOBS}"
