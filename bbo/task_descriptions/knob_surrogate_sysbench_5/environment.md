...
| Field | Value |
|---|---|
| Task ID | `knob_surrogate_sysbench_5` |
| Checkpoint | `RF_SYSBENCH_5knob.joblib` |
| Knob metadata | `knobs_SYSBENCH_top5.json` |
| Environment variable | `AGENTIC_BBO_SYSBENCH5_SURROGATE` |
