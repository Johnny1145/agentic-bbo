...
| Field | Value |
|---|---|
| Task ID | `knob_surrogate_job_5` |
| Checkpoint | `RF_JOB_5knob.joblib` |
| Knob metadata | `knobs_JOB_top5.json` |
| Environment variable | `AGENTIC_BBO_JOB5_SURROGATE` |
...
- the five-variable JSON is reconciled with the intended source-artifact feature selection before describing it as a top-five ranked space;
