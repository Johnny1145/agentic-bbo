...
| Field | Value |
|---|---|
| Task ID | `knob_surrogate_pg_20` |
| Checkpoint | `pg_20.joblib` |
| Knob metadata | `knobs_pg_top20.json` |
| Environment variable | `AGENTIC_BBO_PG20_SURROGATE` |
...
- the twenty-variable JSON is reconciled with the intended source-artifact feature selection before describing it as a top-twenty ranked space;
